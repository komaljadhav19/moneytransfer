...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="view.php">View Customers</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        <div class="row color">
            ...
            <div class="col-md-offset-2 col-md-8 view-data">
                <table class="table">
                    <thead>
                        <tr class="tr">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Transfer"><a href=" transfer.php?id=<?php echo $row['id'] ; ?>"> <button
                                        type="button" class="btn transfer-btn">Transfer</button></a></td>
                        </tr>
                        <?php
                        }
                        ?>
    ...
    <footer class="text-center view-footer">
